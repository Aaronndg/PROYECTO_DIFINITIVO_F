...
-- 8. NOTA: Los usuarios se crearán automáticamente cuando se registren en la app
-- ====================================================================
-- Los perfiles de usuario se crean automáticamente a través de la autenticación
-- No necesitamos insertar usuarios demo aquí
